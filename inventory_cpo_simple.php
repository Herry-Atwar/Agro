...
<style>
    /* Custom orange theme for CPO inventory page */
...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            <h1><i class="bi bi-clipboard-data"></i> CPO Inventory Report</h1>
...
<div class="row mb-4">
    ...
    <div class="col-md-2">
        <div class="card stat-card">
            <div class="card-body text-center">
                <h4><?php echo $inventory_summary['active_tanks'] ?? 0; ?> / <?php echo $inventory_summary['total_tanks'] ?? 0; ?></h4>
                <small>Active Tanks</small>
                <div class="text-muted mt-1">
                    <span class="badge bg-danger"><?php echo $inventory_summary['critical_tanks'] ?? 0; ?></span> Critical
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <i class="bi bi-database"></i> Tank Inventory Summary
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                <?php foreach ($tanks as $tank): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <?php echo format_number($tank['capacity_kg'], 0); ?>
                                            <br><small class="text-muted"><?php echo format_number($tank['capacity_kg']/1000, 2); ?> MT</small>
                                        </td>
                                        <td class="text-end">
                                            <strong><?php echo format_number($tank['current_stock_kg'], 0); ?></strong>
                                        ...
                                        <td>
                                            <div class="progress" style="height: 25px;">
                                                <div class="progress-bar bg-<?php 
                                                    echo $tank['utilization_percentage'] >= 90 ? 'danger' : 
                                                        ($tank['utilization_percentage'] >= 70 ? 'warning' : 'success'); 
                                                ?>" 
                                                     role="progressbar" 
