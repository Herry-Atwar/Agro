...
$pageTitle = 'Update Activity Budget Item';
$db = getDB();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'update') {
        try {
            ...
            $success = "Activity budget item updated successfully!";
    ...
    if ($action === 'update_full') {
        try {
            ...
            $success = "Activity budget item details updated successfully!";
        } catch (PDOException $e) {
            $error = "Update failed: " . $e->getMessage() .
                     " — <a href='fix_capital_budget_columns.php'>Run the column fix script</a> then try again.";
        }
        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="activity_budget_capital.php">Activity Budget</a></li>
                    <li class="breadcrumb-item active">Update Item</li>
                </ol>
            </nav>
            <h2><i class="bi bi-pencil-square"></i> Update Activity Budget Item</h2>
            <p class="text-muted">Update status, dates, and details for activity budget item</p>
        </div>
    </div>
