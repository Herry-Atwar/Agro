                ...
                <div class="row">
                    <div class="col-md-6">
                        <table class="table table-sm">
                            <tr><th width="40%">Batch Number:</th><td><strong><?php echo htmlspecialchars($batch['batch_no']); ?></strong></td></tr>
                            <tr><th>Mill:</th><td><?php echo htmlspecialchars($batch['mill_name']); ?></td></tr>
                            <tr><th>Mill Code:</th><td><?php echo htmlspecialchars($batch['mill_code']); ?></td></tr>
                            <tr><th>Processing Date:</th><td><?php echo format_date($batch['processing_date']); ?></td></tr>
                            <tr><th>Shift:</th><td><?php echo ucfirst(str_replace('_', ' ', $batch['shift'])); ?></td></tr>
                            <tr><th>Start Time:</th><td><?php echo date('H:i', strtotime($batch['start_time'])); ?></td></tr>
                            <tr><th>End Time:</th><td><?php echo $batch['end_time'] ? date('H:i', strtotime($batch['end_time'])) : '-'; ?></td></tr>
                            <tr><th>Duration:</th><td><?php echo $batch['duration_hours'] ? format_number($batch['duration_hours'], 1) . ' hours' : '-'; ?></td></tr>
                        </table>
                    </div>
                    <div class="col-md-6">
                        <table class="table table-sm">
                            <tr><th width="40%">FFB Input:</th><td><?php echo format_number($batch['ffb_input_kg'], 0); ?> Kg</td></tr>
                            <tr><th>Reception IDs:</th><td><?php echo $batch['reception_ids'] ? htmlspecialchars($batch['reception_ids']) : '-'; ?></td></tr>
                            <tr><th>Shift Supervisor:</th><td><?php echo $batch['shift_supervisor'] ? htmlspecialchars($batch['shift_supervisor']) : '-'; ?></td></tr>
                            <tr><th>Operators:</th><td><?php echo $batch['operators'] ? htmlspecialchars($batch['operators']) : '-'; ?></td></tr>
                            <tr><th>Status:</th><td>
                                <span class="badge bg-<?php echo $batch['status'] == 'completed' ? 'success' : ($batch['status'] == 'pending' ? 'warning' : ($batch['status'] == 'cancelled' ? 'danger' : 'info')); ?>">
                                    <?php echo ucfirst($batch['status']); ?>
                                </span>
                            </td></tr>
                            <tr><th>Created:</th><td><?php echo format_date($batch['created_at']); ?></td></tr>
                            <tr><th>Created By:</th><td><?php echo htmlspecialchars($batch['created_by'] ?? ''); ?></td></tr>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="datetime-local" class="form-control" name="start_time" required
                                   value="<?php echo $edit_record ? date('Y-01-01\TH:i', strtotime($edit_record['start_time'])) : ''; ?>">
                        </div>
                        <div class="col-md-4 mb-3">
